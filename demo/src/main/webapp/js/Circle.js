...
*/
  ...
  Circle.prototype.draw = function (
    ...
    if (frame.system !== CooFrameEnum.SYSTEMS.J2000) {
      let lonlat = CooConversion.J2000ToGalactic([
        this.centerRaDec[0],
        this.centerRaDec[1],
      ]);
    ...
    var centerXyview = AladinUtils.xyToView(
      centerXy.X,
      centerXy.Y,
      width,
      height,
    ...
    var dec =
      this.centerRaDec[1] + (ra > 0 ? -this.radiusDegrees : this.radiusDegrees);
    if (frame.system !== CooFrameEnum.SYSTEMS.J2000) {
    ...
    var circlePtXyView = AladinUtils.xyToView(
      circlePtXy.X,
      circlePtXy.Y,
      width,
      height,
