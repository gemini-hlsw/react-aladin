...
const HiPSDefinition = (function () {
  ...
  const HiPSDefinition = function (properties) {
    ...
    this.tileFormats =
      Object.prototype.hasOwnProperty.call(properties, "hips_tile_format") &&
      properties["hips_tile_format"].split(" ");
    this.urls = [];
    this.urls.push(properties["hips_service_url"]);
    var k = 1;
    while (
      Object.prototype.hasOwnProperty.call(properties, "hips_service_url_" + k)
    ) {
  ...
  HiPSDefinition.prototype = {
    ...
    getID: function () {
      ...
      if (
        id == null &&
        Object.prototype.hasOwnProperty.call(this.properties, "publisher_did")
      ) {
  ...
  HiPSDefinition.getLocalStorageDefinitions = function () {
    if (window.localStorage) {
      try {
        var defs = window.localStorage.getItem(
  ...
  var merge = function (baseList, newList) {
    ...
    for (let k = 0; k < baseList.length; k++) {
      ...
      if (Object.prototype.hasOwnProperty.call(newListById, id)) {
        ...
        if (
          Object.prototype.hasOwnProperty.call(item, LAST_URL_KEY) &&
          !Object.prototype.hasOwnProperty.call(itemToAdd, LAST_URL_KEY)
        ) {
  ...
  HiPSDefinition.init = function () {
    ...
    for (let k = 0; k < localDefs.length; k++) {
      var def = localDefs[k];
      if (
        Object.prototype.hasOwnProperty.call(def, RETRIEVAL_TIMESTAMP_KEY) &&
  ...
  HiPSDefinition.findHiPSRemote = function (searchOptions, callback) {
    ...
    if (
      !Object.prototype.hasOwnProperty.call(searchOptions, "dataproduct_type")
    ) {
